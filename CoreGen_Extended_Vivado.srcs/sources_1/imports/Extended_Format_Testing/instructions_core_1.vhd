...
-----------------------------
  constant LDA_IMM : std_logic_vector (7 downto 0) := x"86";  -- Loads an immediate value into register A
  constant LDB_IMM : std_logic_vector (7 downto 0) := x"35";  -- Loads an immediate value into register B
  constant LDA_DIR : std_logic_vector (7 downto 0) := x"87";  -- Directly loads a desired register into register A
  constant LDB_DIR : std_logic_vector (7 downto 0) := x"36";  -- Directly loads a desired register into register B
  constant STA_DIR : std_logic_vector (7 downto 0) := x"88";  -- Directly stores value in register A to desired location
  ...
  constant BRA     : std_logic_vector (7 downto 0) := x"20";  -- Branches to desired memory location
  constant BMI     : std_logic_vector (7 downto 0) := x"21";  -- Branches to desired memory location if negative (N Flag)
  ...
  constant PSH_A   : std_logic_vector (7 downto 0) := x"23";  -- Pushes value from A onto the stack
  constant PSH_B   : std_logic_vector (7 downto 0) := x"27";  -- Pushes value from B onto the stack
  constant PSH_PC  : std_logic_vector (7 downto 0) := x"24";  -- Only used for interrupt vector, pushes program counter onto stack
  constant PLL_A     : std_logic_vector (7 downto 0) := x"25";  -- Pulls top value off stack into register A
  constant PLL_B    : std_logic_vector (7 downto 0) :=x"28";
